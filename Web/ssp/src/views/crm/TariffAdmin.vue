      ...
      <div class="col s12 m6 14">
          ...
          <div class="card-content white-text">
            ...
            <table >
                ...
                <tbody>
                <tr>
                  <td> <input id="internet" type="text" v-model="Internet_balance" class="validate"> гб</td>
                ...
                <tbody>
                <tr>
                  <td> <input id="Tinternet" type="text" v-model="Internet_cost" class="validate"> гб</td>
              ...
              <tbody>
                <tr>
                  <td> <input id="Winternet" type="text"  v-model="Default_internet_cost" class="validate"> гб</td>
  ...
  methods: {
    ...
    createTariff(){
        var s={
            ...
            'tariffCall': {"Call_cost": this.Call_cost,"Call_balance": this.Call_balance,"Default_call_cost": this.Default_call_cost},
            'tariffInternet': {"Internet_cost": this.Internet_cost,"Internet_balance": this.Internet_balance,"Default_internet_cost": this.Default_internet_cost},
